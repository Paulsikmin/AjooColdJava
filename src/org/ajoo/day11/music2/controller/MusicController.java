package org.ajoo.day11.music2.controller;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import org.ajoo.day11.music2.model.DescTitle;
import org.ajoo.day11.music2.model.Music;
...
public class MusicController {
	...
	public Music findOneByTitle(String title) {
		...
		// for each문 : mList에서 music 하나씩 꺼내서 반복, 없을때까지함
	...
	public void removeOne(String title) {
		...
		int i = 0;
		// List에서 찾을 땐 for문과 if문이 있어야댐 ㅇㅇ? ㅇㅇ
		for(Music music : mList) {
			if(title.equals(music.getTitle())) { // 문자열 비교는 equals
				...
				i++; // 찾았는데 없을 땐 다음 값을 찾기 위해서 수동으로 i값 증가
			}
		}
	}
	// 곡명으로 정렬
